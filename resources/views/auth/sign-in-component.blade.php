...
@section('js_scripts')
    ...
    <script src="metronic_assets\sign_in_inventory.js"></script>
@endsection
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" action="#">
							...
							<div class="fv-row mb-10">
								<div class="row">
									...
									<div class="col-lg-2 rounded bg-portal" style="transform: translate(5px, 5px); margin: 0px auto; width: 40px; height: 40px;">
										<a href="#" class="align-content-center align-self-center
										 text-center">
											<i id="open_eye" style="transform: translate(2px, 11px);" class="d-none text-light fa-regular fa-eye"></i>
											<i id="close_eye" style="transform: translate(2px, 11px);" class="text-light fa-regular fa-eye-slash"></i>
										</a>
										{{-- <div class="card-header">
											<!--begin::Input-->
											<span class="btn btn-sm btn-icon position-absolute translate-middle top-30 end-0 me-n2">
