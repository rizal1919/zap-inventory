...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Service
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    <li class="breadcrumb-item">History Perbaikan Barang</li>
                    {{-- <!--begin::Item-->
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input type="text" data-kt-item-table-filter="search_in_items" class="form-control form-control-solid w-250px ps-14" name="items_name" placeholder="Cari No Seri/ID Service"/>
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--begin::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-project-table-toolbar="base">
                                    ...
                                    <a href="javascript:return false;" class="btn btn-primary" onclick="daftarBarangTersedia()">Tambah Perbaikan</a>
            ...
            <div class="modal-body row">
                <form id="add_item">
                    ...
                    <div class="mb-5">
                        ...
                        <span class="form-text mt-2">This field is autofilled</span>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="nama_kerusakan" class="form-label required">Jenis Kerusakan</label>
                        <input class="form-control" placeholder="Printer tidak bisa mencetak" name="nama_kerusakan" id="nama_kerusakan" />
                    </div>
                    <label for="bukti_kerusakan" class="form-label">Bukti Kerusakan</label>
                    <div class="mb-5 input-group">
                        <input type="file" class="form-control" name="picture" id="bukti_kerusakan" >
                        <button class="btn btn-danger clear-manual-pic">Hapus</button>
                    </div>
                    <div class="mb-1">
                        <label for="service_by" class="form-label">Agen Service</label>
                        <input class="form-control" placeholder="Pak Darwin / PT Pratama" name="service_by" value="Pak Simon Pratama" id="service_by" />
                    </div>
    ...
    <!-- Catatan Modal -->
    <div class="modal fade" id="doneService" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5">Form Catatan Setelah Perbaikan</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body row">
                <form id="done_service">
                    @csrf
                    <textarea name="service_notes" class="form-control" id="catatan" cols="" rows="" placeholder="Tulis apa yang diperbaiki / diganti ..."></textarea>
                    <input type="hidden" name="id_service" id="id_service">
                </form>
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            <button type="button" class="btn btn-primary" onclick="doneService()">Simpan</button>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="editService" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5">Form Kerusakan</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body row">
                <form id="edit_item">
                    ...
                    <div class="mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select class="form-select" data-dropdown-parent="#editService" data-allow-clear="true" name="nomor_seri" id="edit_nomor_seri" data-control="select2" disabled data-placeholder="-- Pilih Nomor Seri --">
                        </select>                                               
                        <!--begin::Description-->
                        <input type="hidden" name="nomor_seri" id="edit_nomor_seri_hidden">
                        <!--end::Description-->
                    </div>
                    <div class="mb-5">
                        <label for="edit_nama_barang" class="form-label required">Nama Barang</label>
                        <input type="text" name="nama_barang" required id="edit_nama_barang" class="form-control text-capitalize" placeholder="Mouse m150">
                        <span class="form-text mt-2">This field is autofilled</span>
                    </div>
                    <div class="mb-5">
                        <label for="edit_tanggal_kerusakan" class="form-label required">Tanggal Kerusakan</label>
                        <input readonly class="form-control form-control-solid rounded rounded-end-0" placeholder="Pick date range" name="tanggal_kerusakan" id="edit_tanggal_kerusakan" />
                    </div>
                    <div class="mb-5">
                        <label for="edit_nama_kerusakan" class="form-label required">Jenis Kerusakan</label>
                        <input class="form-control" placeholder="Printer tidak bisa mencetak" name="nama_kerusakan" id="edit_nama_kerusakan" />
                    </div>
                    <label for="edit_bukti_kerusakan" class="form-label">Bukti Kerusakan</label>
                    <div class="mb-5 input-group">
                        <input type="file" class="form-control" name="picture" id="edit_bukti_kerusakan" >
                        <button class="btn btn-danger clear-manual-pic-onedit">Hapus</button>
                    </div>
                    <img src="" alt="" id="bukti_kerusakan_gambar" class="d-none thumb rounded w-150px mb-5">
                    <div class="mb-1">
                        <label for="edit_service_by" class="form-label">Agen Service</label>
                        <input class="form-control" placeholder="Pak Darwin / PT Pratama" name="service_by" value="Pak Simon Pratama" id="edit_service_by" />
                    </div>
            ...
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            <button type="button" class="btn btn-primary" onclick="editService()">Update Data</button>
            </div>
        </div>
        </div>
    </div>
