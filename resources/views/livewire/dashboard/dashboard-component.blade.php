...
@section('js_scripts')
    ...
    <script src="js\dashboard\category_index.js"></script>
@endsection

@section('main_content')
{{-- <link rel="stylesheet" href="metronic_assets\jquery.dataTables.min.css">
<script type="text/javascript" src="metronic_assets\jquery.dataTables.min.js"></script> --}}
@routes
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <p style="color: gray;" class="mb-2">Hi, {{ auth()->user()->username }}</p>
            ...
            <div class="row mb-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p class="text-primary fw-bolder">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-motherboard mx-4" viewBox="0 0 16 16">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-warning fw-bolder">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pc-display-horizontal mx-4" viewBox="0 0 16 16">
                                    <path d="M1.5 0A1.5 1.5 0 0 0 0 1.5v7A1.5 1.5 0 0 0 1.5 10H6v1H1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5v-1h4.5A1.5 1.5 0 0 0 16 8.5v-7A1.5 1.5 0 0 0 14.5 0h-13Zm0 1h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5ZM12 12.5a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0Zm2 0a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0ZM1.5 12h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1ZM1 14.25a.25.25 0 0 1 .25-.25h5.5a.25.25 0 1 1 0 .5h-5.5a.25.25 0 0 1-.25-.25Z"/>
                                </svg>
                                Jumlah Komputer Aktif
                            </p>
                            <h1 class="mx-4">1250</h1>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-success fw-bolder">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people mx-4" viewBox="0 0 16 16">
