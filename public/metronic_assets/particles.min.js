    ...
    t && Object.deepExtend(m, t),
        ...
        (m.fn.retinaInit = function () {
            m.retina_detect && 1 < window.devicePixelRatio
                ? ((m.canvas.pxratio = window.devicePixelRatio),
                  (m.tmp.retina = !0))
                ...
                (m.particles.size.value =
                    m.tmp.obj.size_value * m.canvas.pxratio),
                (m.particles.size.anim.speed =
                    m.tmp.obj.size_anim_speed * m.canvas.pxratio),
                (m.particles.move.speed =
                    m.tmp.obj.move_speed * m.canvas.pxratio),
            ...
            if (
                ...
                if (e.value instanceof Array) {
                    var i =
                        e.value[
                            Math.floor(
                                Math.random() * m.particles.color.value.length
                            )
                        ];
            ...
            switch (
                ...
                case "star":
                    m.fn.vendors.drawShape(
                        m.canvas.ctx,
                        e.x -
                            (2 * t) / (m.particles.shape.polygon.nb_sides / 4),
                        e.y - t / 1.52,
                        (2 * t * 2.66) /
                            (m.particles.shape.polygon.nb_sides / 3),
                        m.particles.shape.polygon.nb_sides,
                        2
                    );
                    break;
            ...
            m.canvas.ctx.closePath(),
                0 < m.particles.shape.stroke.width &&
                    ((m.canvas.ctx.strokeStyle =
                        m.particles.shape.stroke.color),
            ...
            for (var e = 0; e < m.particles.array.length; e++) {
                    ...
                    (m.particles.opacity.anim.enable &&
                        (1 == t.opacity_status
                            ? (t.opacity >= m.particles.opacity.value &&
                              ...
                              (t.opacity += t.vo))
                            : (t.opacity <=
                                  m.particles.opacity.anim.opacity_min &&
                                  (t.opacity_status = !0),
                              (t.opacity -= t.vo)),
                        t.opacity < 0 && (t.opacity = 0)),
                    m.particles.size.anim.enable &&
                        (1 == t.size_status
                            ? (t.radius >= m.particles.size.value &&
                                  (t.size_status = !1),
                              (t.radius += t.vs))
                ...
                if (
                    ...
                    (isInArray("bubble", m.interactivity.events.onhover.mode) ||
                        isInArray(
                            "bubble",
                            m.interactivity.events.onclick.mode
                        )) &&
                        m.fn.modes.bubbleParticle(t),
                    (isInArray(
                        "repulse",
                        m.interactivity.events.onhover.mode
                    ) ||
                        isInArray(
                            "repulse",
                            m.interactivity.events.onclick.mode
                    ...
                    if (0 <= a && "mousemove" == m.interactivity.status) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                (r = m.interactivity.modes.bubble.opacity * a) >
                                    c.opacity &&
                        ...
                        if (m.tmp.bubble_duration_end)
                            ...
                            if (n != e) {
                                var r =
                                    i -
                                    (l * (i - e)) /
                                        m.interactivity.modes.bubble.duration;
                                "size" == s && (c.radius_bubble = r),
                                    "opacity" == s && (c.opacity_bubble = r);
                            }
                        } else
        ...
        (m.fn.modes.repulseParticle = function (i) {
            if (
                ...
                "bounce" == m.particles.move.out_mode
                    ? (0 < c.x - i.radius &&
                          c.x + i.radius < m.canvas.w &&
                          (i.x = c.x),
                      0 < c.y - i.radius &&
                          c.y + i.radius < m.canvas.h &&
                          (i.y = c.y))
                    : ((i.x = c.x), (i.y = c.y));
            } else if (
                m.interactivity.events.onclick.enable &&
                ...
                if (
                    ...
                    var o = Math.pow(
                            m.interactivity.modes.repulse.distance / 6,
                            3
                        ),
            ...
            if (
                ...
                if (i <= m.interactivity.modes.grab.distance) {
                    var s =
                        ...
                        i /
                            (1 /
                                m.interactivity.modes.grab.line_linked
                                    .opacity) /
                            m.interactivity.modes.grab.distance;
                    if (0 < s) {
        ...
        (m.fn.vendors.eventsListeners = function () {
            "window" == m.interactivity.detect_on
                ...
                (m.interactivity.events.onhover.enable ||
                    m.interactivity.events.onclick.enable) &&
                    (m.interactivity.el.addEventListener(
                        "mousemove",
                        function (e) {
                    ...
                    m.interactivity.el.addEventListener("click", function () {
                        if (
                            ((m.interactivity.mouse.click_pos_x =
                                m.interactivity.mouse.pos_x),
                            (m.interactivity.mouse.click_pos_y =
                                m.interactivity.mouse.pos_y),
                            (m.interactivity.mouse.click_time =
                                new Date().getTime()),
                            m.interactivity.events.onclick.enable)
        ...
        (m.fn.vendors.loadImg = function (e) {
            if (((m.tmp.img_error = void 0), "" != m.particles.shape.image.src))
                ...
                console.log("Error pJS - No image.src"), (m.tmp.img_error = !0);
        }),
            ...
            "image" == m.particles.shape.type
                ? "svg" == m.tmp.img_type
                    ? m.tmp.count_svg >= m.particles.number.value
                        ? (m.fn.particlesDraw(),
                          m.particles.move.enable
                              ? (m.fn.drawAnimFrame = requestAnimFrame(
                                    m.fn.vendors.draw
                                ))
                              : cancelRequestAnimFrame(m.fn.drawAnimFrame))
                        : m.tmp.img_error ||
            ...
            (s.onreadystatechange = function (e) {
                if (4 == s.readyState)
                    if (200 == s.status) {
                        ...
                        console.log(
                            "Error pJS - XMLHttpRequest status: " + s.status
                        ),
